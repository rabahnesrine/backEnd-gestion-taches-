...
public class EmailConstant {
    ...
    public static final String USERNAME = "tacheapp@gmail.com";
    public static final String PASSWORD = "tacheApp23"; //gmail password
    ...
    public static final String SMTP_STARTTLS_ENABLE = "mail.smtp.starttls.enable"; //Transport layer security
