...
public class ExceptionHandling implements ErrorController {
    ...
    private static final String ACCOUNT_DISABLED = "Your account has been disabled.If this is an error, please contact administration: tacheapp@gmail.com";
    ...
    @ExceptionHandler(ProjetNameExistException.class)
    public ResponseEntity<HttpResponse> projetNameExistException(ProjetNameExistException exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }
